			...
			>
				...
				{step === 0 && (
					<div className="w-[50vw]">
						<motion.h1
							variants={line}
							className="hand-coffe text-[5vh] text-left font-extralight"
						>
							<AnimatedText>Moving forward with the guide...</AnimatedText>
						</motion.h1>
						...
						<div className="border-2 border-dashed w-full py-[3vh] pt-[2vh] my-[2vh] h-[50vh] overflow-y-scroll bg-white">
							...
							<div className="flex flex-col items-center justify-between w-fit gap-[1vh] mt-[1vh] px-[3.5vh]">
								<p className="text-[4vh] hand-coffe text-left w-full">
									Hand Coffee font for Headings
								</p>
								<p className="text-[2.5vh] text-left w-full">
									Regular Sans-Serif font for the body text
								</p>
							</div>
							<h2 className="hand-coffe text-[3vh] text-left mt-[3vh] px-[3.5vh] pt-[1.5vh] border-t-2 border-dashed">
								Flow/Story
							...
							<div className="flex flex-col items-center justify-between w-fit gap-[1vh] mt-[1vh] px-[3.5vh]">
								<p className="text-[3.25vh] hand-coffe text-left w-full">
									Landing page {"->"} About Page {"->"} Product Page {"->"}
								</p>
								<p className="text-[3.25vh] hand-coffe text-left w-full">
									Contact Page {"->"} About the Author {"->"} Wrapping up
								</p>
							</div>
						</div>
